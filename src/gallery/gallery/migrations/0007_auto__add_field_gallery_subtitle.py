...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('gallery_gallery', 'subtitle',
                      self.gf('django.db.models.fields.CharField')(default='lol', max_length=200),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Gallery.subtitle'
        db.delete_column('gallery_gallery', 'subtitle')
    ...
    models = {
        ...
        'gallery.photo': {
            ...
            'gallery': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'photos'", 'to': "orm['gallery.Gallery']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
