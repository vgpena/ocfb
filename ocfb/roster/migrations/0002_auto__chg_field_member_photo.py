...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('roster_member', 'photo_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['daguerre.Image']))
    ...
    def backwards(self, orm):
        ...
        # Renaming column for 'Member.photo' to match new field type.
        db.rename_column('roster_member', 'photo_id', 'photo')
        # Changing field 'Member.photo'
        db.alter_column('roster_member', 'photo', self.gf('django.db.models.fields.files.ImageField')(max_length=100))
    ...
    models = {
        ...
        'roster.member': {
            ...
            'photo': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['daguerre.Image']", 'blank': 'True'}),
